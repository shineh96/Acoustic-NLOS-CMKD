...
class Encoder(nn.Module):
    def __init__(self, image_size):
        ...
        self.enc1 = conv_block(in_channels=64, out_channels=64, kernel_size=3, padding=1, stride=2)
        self.enc2 = conv_block(64, 128, 3, 1, 2)
        self.enc3 = conv_block(128, 128, 3, 1, 2)
        self.enc4 = conv_block(128, 256, 3, 1, 2)
        self.enc5 = conv_block(256, 256, 3, 1, 2)
        self.enc6 = conv_block(256, 512, 3, 1, 2)
        self.enc7 = conv_block(512, 512, 3, 1, 2)
        self.enc8 = conv_block(512, 512, 3, 1, 2)
