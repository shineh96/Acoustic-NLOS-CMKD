...
class BaseOptions():
    ...
    def initialize(self):
        # dataset options  
        self.parser.add_argument('--train_path', type=str, default='/home/sewo/Documents/Data/aligned', help='train path to the files')
        self.parser.add_argument('--val_path', type=str, default='/home/sewo/Documents/Data/aligned', help='validation path to the files')
        self.parser.add_argument('--test_path', type=str, default='/home/sewo/Documents/Data/aligned', help='test path to the files')
